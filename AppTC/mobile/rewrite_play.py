        ...
        children: [
          Column(
            ...
            children: [
              ...
              Text(
                'Xả stress sau những giờ code căng thẳng',
          ...
          Expanded(
            child: Column(
              ...
              children: [
                ...
                Text(
                  'Cày game để kiếm thêm xu ốp vào ngân sách ảo nào!',
    ...
    return Padding(
      ...
      child: Column(
        children: [
          ...
          _buildGameCard(
            title: 'Mèo bắt cá',
            desc: 'Thả cần đúng lúc để câu cá quý hiếm',
            icon: Icons.phishing,
            color: Colors.teal,
          ...
          _buildGameCard(
            title: 'Mèo đua top',
            desc: 'Điều khiển né chướng ngại vật mượt mà',
