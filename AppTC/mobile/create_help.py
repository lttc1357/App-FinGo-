...
filepath = 'D:/h\u1ecdc/Thanh toán \u0111i\u1ec7n t\u1eed/app new/AppTC/mobile/lib/screens/help_support_screen.dart'
  ...
  Widget build(BuildContext context) {
    ...
    final List<Map<String, String>> faqs = [
      ...
      },
      {
        ...
        'answer': 'Bạn có thể chuyển đổi ngôn ngữ giữa Tiếng Việt và Tiếng Anh trong phần "Cài đặt ứng dụng" tại trang "Cá nhân".',
      },
      {
...
print("Created Help & Support screen")
