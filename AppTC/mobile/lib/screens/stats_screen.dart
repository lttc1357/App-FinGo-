...
class _StatsScreenState extends State<StatsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final baseTotal = currentData['total'] as double;
    final totalSpent = baseTotal + currentGlobalExpense();
        ...
        return GestureDetector(
          ...
          child: AnimatedContainer(
            ...
            decoration: BoxDecoration(
              color: isSelected ? const Color(0xFF3A7BD5) : Theme.of(context).cardColor,
              ...
              boxShadow: isSelected
                  ...
                  : [BoxShadow(color: (Theme.of(context).brightness == Brightness.dark) ? Colors.grey.shade800 : Colors.grey.shade200, blurRadius: 5)],
            ),
            child: Text(
              period,
              style: GoogleFonts.nunito(
          ...
          Row(
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: vsColor.withValues(alpha: 0.1),
                  borderRadius: BorderRadius.circular(20),
                ),
                child: Row(
                  children: [
  ...
  Widget _buildBudgetCard(double totalSpent) {
    if (_selectedPeriod != 'Tháng') {
      return const SizedBox.shrink(); // Chỉ hiện budget cho tháng
    }
            ...
            children: [
              Text(
                ...
                style: GoogleFonts.nunito(
                  ...
                  color: isDanger ? Colors.redAccent : Theme.of(context).colorScheme.onSurface,
                ),
              ),
              Text(
          ...
          ClipRRect(
            ...
            child: LinearProgressIndicator(
              ...
              valueColor: AlwaysStoppedAnimation<Color>(
                isDanger ? Colors.redAccent : const Color(0xFF3A7BD5),
              ),
            ),
          ),
        ],
  ...
  Widget _buildSurvivalCard(double totalSpent) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        color: (Theme.of(context).brightness == Brightness.dark) ? const Color(0x22FFA726) : const Color(0xFFFFF4E5),
